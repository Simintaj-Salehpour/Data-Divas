...
reg.best10 <- regsubsets(Salary~. , data = hittersC, nvmax = 10, nbest = 2, method = "exhaustive")  # leaps::regsubsets() - Model selection by exhaustive (default) search, forward or backward stepwise, or sequential replacement
...
# 
# Mallow Cp
subsets(reg2.best, statistic="cp", legend = FALSE, min.size = 4, main = "Mallow Cp")
